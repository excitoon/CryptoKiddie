...
/// extension**.
///
/// The ФНС ЛКЮЛ SPA bundles the `crypto-pro` library, which drives
...
/// (not a Proxy — `crypto-pro`'s `isAvailable()` does
...
CSPName:function(){return P('Crypto-Pro GOST R 34.10-2012 KC1 CSP');},
