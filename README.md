...
The bridge is intentionally local-only by default (`127.0.0.1:18765`). It does not install reference implementation CSP, the reference implementation Browser Plugin, or Rutoken vendor drivers.
